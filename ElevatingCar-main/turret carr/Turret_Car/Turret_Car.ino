...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <center><h1 style="color: teal;text-align:center;"> CAR CONTROL </h1></center>
    <h4 style="color: teal;text-align:center;">  </h4>
    ...
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=13>
      ...
      <tr/><tr/>
      <tr>
        <td style="text-align:left;font-size:25px"><b>servo:</b></td>
        <td colspan=2>
         <div class="slidecontainer">
            <input type="range" min="10" max="170" value="90" class="slider" id="Elevate" oninput='sendButtonInput("Elevate",value)'>
          </div>
        </td>
      </tr> 
      <tr/><tr/>
...
void elevateCar(int rightFrontServoValue, int rightBackServoValue)
{
